...
/* PLL source is HSE/1, PLL devider is 2, PLL multiplier is 9: PLL frequency is
 * 16MHz (XTAL) / 2 x 9 = 72MHz
 */

#define STM32_CFGR_PLLSRC       RCC_CFGR_PLLSRC
#define STM32_CFGR_PLLXTPRE     RCC_CFGR_PLLXTPRE
#define STM32_CFGR_PLLMUL       RCC_CFGR_PLLMUL_CLKx9
#define STM32_PLL_FREQUENCY     (9*(STM32_BOARD_XTAL>>1))
